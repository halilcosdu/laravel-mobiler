...
class Container_2d99d10810 extends _PHPStan_7961f7ae1\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService050(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_2d99d10810 $container)
			{
	...
	public function createServiceContainer(): Container_2d99d10810
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 5,
			'paths' => [
				'/Users/halilcosdu/Applications/laravel-mobiler/src',
